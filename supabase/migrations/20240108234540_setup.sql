...
AS $$
DECLARE
  project_url TEXT := 'https://nqwrecfuuioqzibsgnyc.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5xd3JlY2Z1dWlvcXppYnNnbnljIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzMxNjcyNywiZXhwIjoyMDIyODkyNzI3fQ.FkV0tWGZ7zVV2VdMofM76lrt0hBqw4Gp47_dlsHwn-c'; -- full access needed for http request to storage
